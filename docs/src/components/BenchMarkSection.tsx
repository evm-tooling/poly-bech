  ...
  if (disableAnimation) {
    return (
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="text-xs font-medium text-foreground-secondary text-center">
          {label}
        </span>
      </div>
    )
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        ...
        <AnimatedSection delay={0.2}>
          ...
          <p className="mx-auto max-w-lg text-center mb-12">
            Viem-go is blazingly fast. along with careful optimisations, Go's
            compiled runtime crushes JavaScript across every benchmark. No JIT
            warm-up, no GC pauses.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.7}>
          <p className="text-center text-xs text-foreground-muted mt-10">
            * Benchmarks measured on Apple M2, Go 1.22, Node.js 20. Results may
            vary.
          </p>
        </AnimatedSection>
      </div>

...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        className={`absolute top-full right-0 mt-2 min-w-[140px] rounded-lg border border-card-border bg-card p-1 shadow-xl shadow-black/30 z-50 transition-all ${isOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-1'}`}
      >

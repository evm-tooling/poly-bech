...
export default function FeaturesSection() {
  return (
    <section className="relative w-full py-16 px-8 section-bg-dark overflow-hidden">
      ...
      <div
        aria-hidden
        className="glow-orb-ellipse top-1/2 left-1/2 -translate-x-1/2 -translate-y-[55%] h-[600px] w-[1200px] opacity-30 blur-[130px]"
      />
      <div
        aria-hidden
        className="glow-orb-ellipse top-1/2 left-1/2 -translate-x-1/2 -translate-y-[25%] h-[300px] w-[420px] opacity-20 blur-[80px]"
      />

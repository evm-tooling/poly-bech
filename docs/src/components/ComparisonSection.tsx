...
const rows: {
  ...
  {
    feature: 'High-level API',
    featureMobile: 'High-level',
    viemGo: 'yes',
    goEth: 'no',
  },
  {
    feature: 'Familiar to viem users',
    featureMobile: 'viem API',
    viemGo: 'yes',
    goEth: 'no',
  },
  {
    feature: 'Type-safe ABI encoding',
    featureMobile: 'Type-safe',
    viemGo: 'yes',
    goEth: 'yes',
  },
  {
    feature: 'Multiple account types',
    featureMobile: 'Accounts',
    viemGo: 'yes',
    goEth: 'partial',
  },
  {
    feature: 'Transport abstraction',
    featureMobile: 'Transports',
    viemGo: 'yes',
    goEth: 'no',
  },
  {
    feature: 'Contract bindings',
    featureMobile: 'Contracts',
    viemGo: 'yes',
    goEth: 'partial',
  },
  {
...
const StatusCell = ({ status }: { status: Status }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs text-warning font-medium hidden sm:inline">
        Partial
      </span>
    </div>
  )
    ...
    <div className="relative mx-auto max-w-4xl px-6">
      <AnimatedSection>
        <div className="mb-4 text-center">
          <span className="section-badge section-badge-tertiary">
            Head to Head
          </span>
        </div>
      ...
      <AnimatedSection delay={0.15}>
        ...
        >
          ...
          <div className="grid grid-cols-[1fr_60px_60px] sm:grid-cols-[1fr_180px_180px] border-b border-border bg-background-elevated/40">
            <div className="px-3 sm:px-6 py-3 sm:py-4 text-xs font-bold uppercase tracking-wider text-foreground-muted">
              Feature
            </div>
            <div className="px-1 sm:px-4 py-3 sm:py-4 text-center">
              <span className="inline-flex items-center rounded-full bg-primary/10 px-1.5 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs font-bold text-primary">
                viem
              </span>
            </div>
            <div className="px-1 sm:px-4 py-3 sm:py-4 text-center">
              <span className="inline-flex items-center rounded-full bg-background-secondary px-1.5 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs font-bold text-foreground-secondary">
                geth
              </span>
            </div>
          </div>
          ...
          {rows.map((row, i) => (
            ...
            >
              ...
              <div className="flex justify-center px-1 sm:px-4 py-3 sm:py-4">
          ...
          <div className="grid grid-cols-[1fr_60px_60px] sm:grid-cols-[1fr_180px_180px] border-t border-border bg-background-elevated/30">
            <div className="px-3 sm:px-6 py-2 sm:py-3 text-xs font-bold uppercase tracking-wider text-foreground-muted">
              Score
            </div>
            <div className="px-1 sm:px-4 py-2 sm:py-3 text-center">
              <span className="text-base sm:text-lg font-black text-primary">
                7/7
              </span>
            </div>
            <div className="px-1 sm:px-4 py-2 sm:py-3 text-center">
              <span className="text-base sm:text-lg font-black text-foreground-muted">
                2/7
              </span>
            </div>
          </div>

...
| `poly-bench lsp` | Start the language server (v2) |
...
The LSP server communicates over stdio. See [LSP / Editor Support](/docs/tools/lsp) for editor configuration.
...
- [LSP / Editor Support](/docs/tools/lsp) — Editor configuration

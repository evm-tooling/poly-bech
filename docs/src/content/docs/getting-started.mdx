...
<Aside type="tip">
<span>Add <code>charting.drawBarChart(...)</code> directives in your <code>after</code> block to automatically generate SVG visualizations. See the <a href="/docs/reporting">Reporting</a> page for details.</span>
</Aside>

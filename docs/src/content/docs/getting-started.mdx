...
<Aside type="tip">
<span>Add <code>charting.drawBarChart(...)</code> directives in your <code>after</code> block to automatically generate SVG visualizations. See the <a href="/docs/performance/">Reporting</a> page for details.</span>
</Aside>
...
- Learn about the [DSL Reference](/docs/clients/public/) for full syntax documentation
- Explore the [Standard Library](/docs/clients/wallet/) for `std::anvil` and `std::charting`
- See [Examples](/docs/examples/) for real-world benchmark patterns
- Check out [CLI Reference](/docs/clients/transports/http/) for all command options

...
impl ChartParam {
    ...
    pub fn dsl_name(&self) -> &'static str {
        match self {
            ...
            ChartParam::ShowStatsTable => "showStatsTable",
        }
    }
    ...
    pub fn from_dsl_name(name: &str) -> Option<ChartParam> {
        match name {
            ...
            "showStatsTable" => Some(ChartParam::ShowStatsTable),
            _ => None,
        }
    }
}
...
pub fn get_valid_params(chart_type: ChartType) -> HashSet<ChartParam> {
    ...
    match chart_type {
        ...
        ChartType::LineChart | ChartType::BarChart => {
            ...
            params.insert(ChartParam::ShowStatsTable);
        }
    }

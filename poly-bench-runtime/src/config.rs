...
//!
//! Provides language-specific project root paths used when creating runtimes.
//! This type is separate from executor's ProjectRoots to avoid circular dependencies.

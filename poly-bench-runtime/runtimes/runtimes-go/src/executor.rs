...
use crate::{compiler::GoCompiler, error_mapping::GoErrorMapper};
...
/// Factory for creating Go runtime instances
pub struct GoRuntimeFactory;

pub static GO_RUNTIME_FACTORY: GoRuntimeFactory = GoRuntimeFactory;
